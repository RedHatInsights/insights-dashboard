...
export const OCP_SUMMARY_FETCH_URL = `${BASE_URL}/https://api.access.ci.itop.redhat.com/r/insights/platform/\
									  cost-management/api/v1/reports/charges/ocp/?filter[time_scope_units]=mon\
