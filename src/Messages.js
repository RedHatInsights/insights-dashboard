...
export default defineMessages({
  ...
  incidents: {
    ...
    defaultMessage:
      '{incidents, plural, one {# incident} other {# incidents}} detected',
  },
  critical: {
    id: 'critical',
  ...
  cvesImpactingSystems: {
    ...
    defaultMessage:
      '{cves, plural, one {CVE} other {CVEs}} impacting your systems',
  },
  cvesImpactingOneOrMoreSystems: {
    id: 'cvesImpactingOneOrMoreSystems',
    description: 'Vulnerability - cve impacting link',
    defaultMessage:
      '{cves, plural, one {CVE} other {CVEs}} with <strong>security rules</strong> impacting 1 or more systems',
  },
  knownExploitsOneOrMoreSystems: {
    id: 'knownExploitsOneOrMoreSystems',
    description: 'Vulnerability - known exploits link',
    defaultMessage:
      '{cves, plural, one {CVE} other {CVEs}} with <strong>known exploits</strong> impacting 1 or more systems<tooltip></tooltip>',
  },
  ...
  securityAdvisories: {
    ...
    defaultMessage:
      '{count, plural, one {security advisory} other {security advisories}}',
  },
  bugfixAdvisories: {
    id: 'bugfixAdvisories',
  ...
  systemsAffected: {
    ...
    defaultMessage:
      '{count, plural, one {# system} other {# systems}} affected',
  },
  patchTitle: {
    id: 'patchTitle',
  ...
  systemInventoryStaleWarning: {
    ...
    defaultMessage:
      '{count, plural, one {# system} other {# systems}} to be removed',
  },
  systemInventoryStale: {
    id: 'systemInventoryStale',
    description: 'System inventory - stale',
    defaultMessage:
      '{count, plural, one {# stale system} other {# stale systems}}',
  },
  systemInventoryCTA: {
  ...
  systemInventoryNoAccess: {
    ...
    defaultMessage:
      'Your organization administrator must grant you inventory access to view your systems.',
  },
  remediationsTotal: {
  ...
  getStartedLightSpeed: {
    ...
    defaultMessage:
      'Get started with Red Hat Lightspeed by registering your systems with us.',
  },
  notMember: {
    id: 'notMember',
  ...
  functionalityNotSupported: {
    ...
    defaultMessage:
      'This functionality is not supported within {appname}. Remove all filters to show dashboard results.',
  },
  filteredResultsInApp: {
    id: 'filteredResultsInApp',
    description: 'Filtered results are available directly',
    defaultMessage:
      'Filtered results are available directly within the {appname} application.',
  },
  filterNotApplicable: {
  ...
  insightsDescription:
    'Single, consistent management solution across on-premise, hybrid cloud, and public cloud. Included with Red Hat Enterprise Linux subscription. Single, consistent management solution across on-premise, hybrid cloud, and public cloud.',
  contactsales: {
    id: 'contactsales',
  ...
  rhm1: {
    ...
    defaultMessage:
      'Red Hat Management gives you the flexibility to manage Red Hat Enterprise Linux on-premise or in a hosted environment',
  },
  rhm2: {
    id: 'rhm2',
    description: 'zero state last box',
    defaultMessage:
      'Red Hat Management covers your entire system and security management life cycle',
  },
  rhm3: {
    id: 'rhm3',
    description: 'zero state last box',
    defaultMessage:
      'Red Hat Management includes Red Hat Satellite and the new cloud management services for Red Hat Enterprise Linux',
  },
  securityRedirect: {
    id: 'securityRedirect',
  ...
  zsrblBody: {
    ...
    defaultMessage:
      'Identify risks in advance, and filter to focus on the most important ones. Continually analyze against a large volume of Red Hat industry vulnerability and compliance advisories, as well as your own policies without manual steps.',
  },
  zsrblb1: {
    id: 'zsrblb1',
  ...
  rosSystemsNotConfiguredMessage: {
    ...
    defaultMessage:
      'No systems configured yet? Get started with resource optimization.',
  },
  rosSystemsGenericMessage: {
    id: 'rosSystemsGenericMessage',
    description:
      'when systems details are available in the resource optimization message',
    defaultMessage:
      'Red Hat recommends to assess and monitor cloud usage and optimization on these systems.',
  },
  waitingForData: {
    id: 'waitingForData',
  ...
  systemsExposedDescription: {
    ...
    defaultMessage:
      'The count of the systems exposed is the total across all CVEs listed under the Associated CVEs section for this rule.',
  },
  collapse: {
    id: 'collapse',
  ...
  advisorZeroState: {
    ...
    defaultMessage:
      "Using Red Hat's expertise, analyze your RHEL hosts to identify and resolve risks to availability, performance, and stability in your environment.",
  },
  complianceZeroState: {
  ...
  imageBuilderZeroState: {
    ...
    defaultMessage:
      'Build and customize RHEL images for cloud and on-premise environments.',
  },
  patchZeroState: {
    id: 'patchZeroState',
    description: 'Zero state description for Patch app',
    defaultMessage:
      'The patch service gives you the information you need to confidently update your RHEL systems with Red Hat product advisories and packages.',
  },
  malwareZeroState: {
    id: 'malwaretZeroState',
    description: 'Zero state description for Malware app',
    defaultMessage:
      'The malware detection service monitors your RHEL hosts for the presence of known malware signatures to indicate potential threats that you can proactively address with your information security team.',
  },
  ...
  activationKeyZeroState: {
    ...
    defaultMessage:
      'Register systems to Subscription Manager and get the correct content for your image.',
  },
  customContentZeroState: {
    id: 'customContentZeroState',
    description: 'Zero state description for Custom content app',
    defaultMessage:
      'Add custom repositories to images built with Image Builder.',
  },
