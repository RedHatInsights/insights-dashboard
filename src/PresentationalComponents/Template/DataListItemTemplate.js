    ...
    >
      <DataListItemRow className="insd-c-dashboard-data-list__controller-row">
        ...
        <DataListItemCells
          dataListCells={[
            <DataListCell
              key={`key-${dataListItemTemplateKey}-datalist-cell`}
              className="insd-c-dashboard-data-list__controller-row-cell"
            >
              <div className="insd-c-new-rules-severities">
                ...
                >
                  {dataListItemTemplateSeverity === 1 && (
                    <Label icon={<DashboardIcon type="lowSeverity" />}>
                      {capitalize(intl.formatMessage(messages.low))}
                    </Label>
                  )}
                  {dataListItemTemplateSeverity === 2 && (
                    <Label
                      color="blue"
                      icon={<DashboardIcon type="moderateSeverity" />}
                    >
                  ...
                  {dataListItemTemplateSeverity === 3 && (
                    <Label
                      color="orange"
                      icon={<DashboardIcon type="importantSeverity" />}
                    >
                  ...
                  {dataListItemTemplateSeverity === 4 && (
                    <Label
                      color="red"
                      icon={<DashboardIcon type="criticalSeverity" />}
                    >
              ...
              <span className="insd-c-dashboard-data-list__date pf-v6-u-color-200 pf-v6-u-font-size-sm">
              ...
              <Title
                headingLevel="h4"
                size="md"
                className="pf-v6-u-font-weight-light insd-c-title-toggle"
                id={`itemDescription-${dataListItemTemplateKey}`}
              >
                <span>
                  {capitalize(
                    intl.formatMessage({
