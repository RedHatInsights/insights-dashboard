...
export const TemplateCard = ({ appName, children, ...props }) => (
  <Card
    className={`insd-c-dashboard__card insd-c-dashboard__card--${appName}`}
    {...props}
  >
    {children}
  </Card>
...
export const TemplateCardHeader = ({
  ...
  <CardHeader className="insd-c-dashboard__card--header" {...props}>
    ...
    {children}
    {onDownload && (
      <Button variant="link" icon={<DownloadIcon />} onClick={onDownload}>
        Report
      </Button>
    )}
  </CardHeader>
...
export const TemplateCardBody = ({
  ...
  <CardBody
    className={`insd-c-dashboard__card--body ${isHorizontalLayout ? ' insd-m-horizontal' : ''}`}
    {...props}
  >
    {children}
  </CardBody>
