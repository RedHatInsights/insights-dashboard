...
const ZeroState = () => {
  ...
  return (
    <div className="insd-c-marketing-page">
      <MarketingBanner
        hasGraphic
        graphicRight
        dark1000
            ...
            <Flex direction={{ default: 'column' }}>
              ...
              <FlexItem spacer={{ default: 'spacer2xl' }}>
                <div
                  ...
                  style={{ '--insd-c-width-limiter--MaxWidth': '600px' }}
                >
                  <p className="ins-c-text--black-400">
                    {intl.formatMessage(messages.singleConsistent)}
                  </p>
                </div>
              </FlexItem>
              <FlexItem>
          ...
          <GridItem>
            <Card style={{ height: '100%' }}>
              <CardHeader>
                <Content>
                  <Title headingLevel="h2">
                    {intl.formatMessage(messages.zslblTitle)}
                  </Title>
              ...
              <CardBody>
                <IconList>
                  <IconListItem>
                    {intl.formatMessage(messages.zslblb1)}
                  </IconListItem>
                  <IconListItem>
                    {intl.formatMessage(messages.zslblb2)}
                  </IconListItem>
                  <IconListItem>
                    {intl.formatMessage(messages.zslblb3)}
                  </IconListItem>
                  <IconListItem>
                    {intl.formatMessage(messages.zslblb4)}
                  </IconListItem>
                  <IconListItem>
                    {intl.formatMessage(messages.zslblb5)}
                  </IconListItem>
                </IconList>
              </CardBody>
            </Card>
          ...
          <GridItem>
            <Card style={{ height: '100%' }}>
              <CardHeader>
                <Content>
                  <Title headingLevel="h2">
                    {intl.formatMessage(messages.zsrblTitle)}
                  </Title>
              ...
              <CardBody>
                <IconList>
                  <IconListItem>
                    {intl.formatMessage(messages.zsrblb1)}
                  </IconListItem>
                  <IconListItem>
                    {intl.formatMessage(messages.zsrblb2)}
                  </IconListItem>
                  <IconListItem>
                    {intl.formatMessage(messages.zsrblb3)}
                  </IconListItem>
                  <IconListItem>
                    {intl.formatMessage(messages.zsrblb4)}
                  </IconListItem>
                  <IconListItem>
                    {intl.formatMessage(messages.zsrblb5)}
                  </IconListItem>
                </IconList>
              </CardBody>
            </Card>
        ...
        <Flex direction={{ default: 'column' }}>
          ...
          <FlexItem>
            <Grid hasGutter>
              ...
              <GridItem md={6} lg={7}>
                <div
                  className="insd-c-width-limiter pf-v6-u-pt-lg-on-lg"
                  style={{ '--insd-c-width-limiter--MaxWidth': '600px' }}
                >
                  <List>
