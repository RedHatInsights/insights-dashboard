...
const ZeroStateBanner = ({
  ...
  return (
    <div aria-label="ZeroStateBanner" className="insd-c-marketing-page warning">
      <MarketingBanner
        dark1000
        style={{
      ...
      >
        <Grid
          lg={6}
          hasGutter
          className="marketing-banner-content pf-v6-u-pt-xl pf-v6-u-pb-xl"
        >
          <GridItem className="pf-v6-u-pl-lg pf-v6-u-pr-lg">
            <Flex direction={{ default: 'column' }}>
              ...
              <FlexItem spacer={{ default: 'spacerXl' }}>
                <Title headingLevel="h4" style={{ maxWidth: '600px' }}>
                  {description}
                </Title>
              </FlexItem>
              <FlexItem>
                <IconList className="pf-v6-u-pl-sm ">
                  {bulletPoints.map((item) => (
                    <IconListItem key={item}>
                      <Title headingLevel="h4">{item}</Title>
                    </IconListItem>
                  ))}
                </IconList>
              </FlexItem>
          ...
          <GridItem
            ...
            className={!registerButton ? 'bannerBefore' : ''}
          >
            {registerButton ? (
              <Flex
              ...
              >
                <FlexItem className="pf-v6-u-pt-lg">
                  <Title
                    ...
                    size="2xl"
                    style={{ color: '#151515' }}
                    ouiaId="ZeroStateCustomAppTitle"
                  >
                    {customTitle
                      ? customTitle
