...
describe('Advisor component renders', () => {
  ...
  it('The count is correct', () => {
    ...
    cy.get('span:contains("incidents detected")')
      .first()
      .should('include.text', INCIDENTS_DETECTED_NUM);

    // Recommendations by total risk section
    cy.get('a:contains("Critical")')
      .find('span')
      .first()
      .should('have.text', CRITICAL_RECOMMENDATIONS_NUM);
    cy.get('a:contains("Important")')
      .find('span')
      .first()
      .should('have.text', IMPORTANT_RECOMMENDATIONS_NUM);
    cy.get('a:contains("Moderate")')
      .find('span')
      .first()
      .should('have.text', MODERATE_RECOMMENDATIONS_NUM);
    cy.get('a:contains("Low")')
      .find('span')
      .first()
      .should('have.text', LOW_RECOMMENDATIONS_NUM);

    // Recommendations by category section
    cy.get('a:contains("Availability")')
      .find('span')
      .eq(1)
      .should('include.text', AVAILABILITY_RECOMMENDATIONS_NUM);
    cy.get('a:contains("Stability")')
      .find('span')
      .eq(1)
      .should('include.text', STABILITY_RECOMMENDATIONS_NUM);
    cy.get('a:contains("Performance")')
      .find('span')
      .eq(1)
      .should('include.text', PERFORMANCE_RECOMMENDATIONS_NUM);
    cy.get('a:contains("Security")')
      .find('span')
      .eq(1)
      .should('include.text', SECURITY_RECOMMENDATIONS_NUM);
  });
  ...
  it('Check that links point to the right URLs.', () => {
    ...
    cy.get('div[id*="Advisor"]')
      ...
      .should(
        'equal',
        '/insights/advisor/recommendations?reports_shown=true&impacting=true&offset=0&limit=10&sort=-publish_date&incident=true',
      );
    ...
    cy.get('a:contains("Critical")')
      ...
      .should(
        'equal',
        '/insights/advisor/recommendations?sort=-total_risk&total_risk=4&reports_shown=true&impacting=true&offset=0&limit=10',
      );
    ...
    cy.get('a:contains("Important")')
      ...
      .should(
        'equal',
        '/insights/advisor/recommendations?sort=-total_risk&total_risk=3&reports_shown=true&impacting=true&offset=0&limit=10',
      );
    ...
    cy.get('a:contains("Moderate")')
      ...
      .should(
        'equal',
        '/insights/advisor/recommendations?sort=-total_risk&total_risk=2&reports_shown=true&impacting=true&offset=0&limit=10',
      );
    ...
    cy.get('a:contains("Low")')
      ...
      .should(
        'equal',
        '/insights/advisor/recommendations?sort=-total_risk&total_risk=1&reports_shown=true&impacting=true&offset=0&limit=10',
      );
    ...
    cy.get('a:contains("Availability")')
      ...
      .should(
        'equal',
        '/insights/advisor/recommendations?sort=-category&category=1&reports_shown=true&impacting=true&offset=0&limit=10',
      );
    ...
    cy.get('a:contains("Stability")')
      ...
      .should(
        'equal',
        '/insights/advisor/recommendations?sort=-category&category=3&reports_shown=true&impacting=true&offset=0&limit=10',
      );
    ...
    cy.get('a:contains("Performance")')
      ...
      .should(
        'equal',
        '/insights/advisor/recommendations?sort=-category&category=4&reports_shown=true&impacting=true&offset=0&limit=10',
      );
    ...
    cy.get('a:contains("Security")')
      ...
      .should(
        'equal',
        '/insights/advisor/recommendations?sort=-category&category=2&reports_shown=true&impacting=true&offset=0&limit=10',
      );
  });
  ...
  it('Check that the Advisor recommendations expandable section can be expanded.', () => {
    cy.get('button[id*="Advisor-toggle-button"][aria-expanded="true"]').should(
      'exist',
    );
    cy.get('div[id*="Advisor"]')
      .find('button[class*="pf-m-secondary"]')
      .should('exist');
  ...
  it('Check that the Recommendations by total risk expandable section can be expanded.', () => {
    cy.get('div[class*="skeleton"]').should('not.exist');
    cy.get(
      'button[id*="advisor-recommendation-by-total-risk-toggle-button"][aria-expanded="true"]',
    ).should('exist');
    ...
    cy.get(
      'button[id*="advisor-recommendation-by-total-risk-toggle-button"]',
    ).click();
