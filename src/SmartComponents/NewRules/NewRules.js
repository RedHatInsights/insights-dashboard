...
const DistilledDataList = ({ vulnerabilities }) => {
    const intl = useIntl();
    const { recent_rules: newRules } = vulnerabilities;
    const severityColor = {
        1: ['#2b9af3', '#06c'],
        2: ['#f4c145', '#c58c00'],
        3: ['#ec7a08', '#8f4700'],
    ...
    return <DataList className='ins-c-dashboard-data-list ins-m-toggle-right-on-md ins-m-no-border'
        gridBreakpoint='none'>
                    ...
                    >
                        <Flex direction={ { default: 'column' } } flex={ { md: 'flex_3', xl: 'flexDefault' } }>
                            ...
                            <Flex flexDefault={ { md: 'flex_1', xl: 'flexDefault' } }>
                                <Button component="a" href={ `${UI_BASE}/vulnerability/cves/${item.id}` }
                            ...
                            <Flex alignItems={ { default: 'alignItemsCenter' } } flexWrap={ { default: 'nowrap' } }>
                                <FlexItem>
                                    <PieChart
                                        ...
                                        ariaTitle="--"
                                        data={ [
                                            { x: 'Total systems', y: vulnerabilities.system_count },
