  ...
  return (
    <ExpandableCardTemplate
      ...
      isExpanded={JSON.parse(
        localStorage.getItem('dashboard_expanded_remediations') || 'true',
      )}
      isExpandedCallback={(isExpanded) =>
        localStorage.setItem('dashboard_expanded_remediations', isExpanded)
      }
              ...
              <React.Fragment>
                ...
                {remediations.meta.total > remediations.meta.count && (
                  <div className="insd-c-remediations-container">
                    <div className="insd-c-remediation__status"></div>
...
export default connect(mapStateToProps, mapDispatchToProps)(RemediationsCard);
