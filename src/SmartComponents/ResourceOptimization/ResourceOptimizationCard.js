  ...
  return (
    <ExpandableCardTemplate
      ...
      isExpanded={JSON.parse(
        localStorage.getItem('dashboard_expanded_ros') || 'true',
      )}
      isExpandedCallback={(isExpanded) =>
        localStorage.setItem('dashboard_expanded_ros', isExpanded)
      }
      body={
        <TemplateCardBody>
          {rosIsConfiguredFetchStatus === 'fulfilled' &&
            (rosIsConfigured.success ? (
              <React.Fragment>
                <div>
                  {intl.formatMessage(messages.rosSystemsGenericMessage)}
                </div>
                <Flex
                  ...
                  >
                    ...
                    <StatsLink
                      ...
                      label={intl.formatMessage(
                        messages.systemsWithSuggestions,
                      )}
                    />
                    <StatsLink
                      to={allSystemsUrl}
              ...
              >
                <FlexItem>
                  {intl.formatMessage(messages.rosSystemsNotConfiguredMessage)}
                </FlexItem>
          ...
          {rosIsConfiguredFetchStatus === 'rejected' && (
            <FailState appName="Resource optimization" />
          )}
        </TemplateCardBody>
      }
    />
